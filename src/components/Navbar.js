...
function Navbar() {
  ...
  return (
    <div>
        <Box w="100%" h="60px" bgColor={navbarbg} zIndex="999" backdropFilter="blur(10px) saturate(200%)" position="fixed" top="0"> 
            <Flex alignItems="center" h="100%" mx="3">
                <Flex className="navbar_left" justifyContent="left" w="100%">
                    <Link fontSize="xl" fontWeight="bold" href="/">React MAL</Link>
                </Flex>
